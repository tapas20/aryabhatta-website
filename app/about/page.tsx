      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-lg text-white/70 mt-6 max-w-2xl mx-auto leading-relaxed">
            BrightMind Academy has been nurturing academic excellence since 2015.
            We provide a supportive, result-oriented learning environment where
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-indigo-50 rounded-2xl p-8 border border-indigo-100">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                leaders in their chosen fields. We envision a future where
                every student realizes their full potential through quality education.
              </p>
            </div>
            ...
            <div className="bg-violet-50 rounded-2xl p-8 border border-violet-100">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                strong conceptual foundations and prepares students to excel
                in board exams and competitive entrance tests. We are committed
                to personalized learning with experienced faculty and modern
