  ...
  return (
    <div ref={ref} className="text-center">
      ...
      <div className="flex items-baseline justify-center gap-0.5">
        ...
        <span className="text-3xl md:text-4xl font-bold text-white/70">
          {suffix}
        </span>
      </div>
...
export default function Recognition() {
  return (
    <section className="w-full bg-gradient-to-r from-primary via-teal-700 to-teal-800 py-14 relative overflow-hidden">
      {/* Decorative */}
